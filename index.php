<?php
	require_once('conexao.php'); // conexão com o conexão (sem ../, pois esta no mexmo diretorio)
		// nesse caso fiz a conexao com o conexao.php pois no conexão.php ja faz referencia ao config.php
	?>
...
<head>
    <!-- $nome_sistema variavel localizado no config -->
    <title><?php echo $nome_sistema	?></title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="vendor/login/favicon.ico" />
    <!--===============================================================================================-->
            ...
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" method="post" action="autenticar.php">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Email ou CPF">
                        <input class="input100" type="text" name="usuario" placeholder="email/cpf" required=''>
